...
그러기 위해서 추가적으로 알아야 하는 개념들이 더 있습니다만(JavaScript에서 변수가 저장되는 과정, 실행 컨텍스트, this, 콜백함수, 클로저 ...) 그 중에서도 JavaScript의 실행 컨텍스트를 잘 이해하려면 이번 글에서 다루었던 호이스팅에 대한 개념이 단단하게 정립되어 있어야 합니다.
