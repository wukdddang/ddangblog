...
> - 정보: ES5의 실행 컨텍스트는 thisBinding에 대한 정보를 별도로 저장하였지만, ES6 이후부터는 EnvironmentRecord에서 this에 대한 정보를 저장합니다.
...
<div className="mx-auto w-64">![emptyContext](/static/images/empty-context.png)</div>

JavaScript 코드가 실행되기 전에는, 우리가 사용하려는 콜 스택은 비어있게 됩니다. JavaScript 코드를 실행하는 순간, 전역 실행 컨텍스트가 콜 스택에 담기게 됩니다.